	  ...
	  Search
		...
		<div class="container container-fluid">
			<div class="row content" data-finder-content>
				<div class="col-sm-6">
					<div class="card">
						<h5 class="card-header">Terms Validator</h5>
						<div class="card-body">
				...
				<div class="col-sm-6">
					<div class="card">
						<h5 class="card-header">Terms Utility</h5>
						<div class="card-body">
				...
				<div class="col-sm-6">
					<div class="card">
						<h5 class="card-header">Subtitle Validator</h5>
						<div class="card-body">
							<h5 class="card-title">Validator</h5>
				...
				<div class="col-sm-6">
					<div class="card">
						<h5 class="card-header">Subtitle Utility</h5>
						<div class="card-body">
				...
				<div class="col-sm-6">
					<div class="card">
						<h5 class="card-header">Indic Transliteration</h5>
						<div class="card-body">
				...
				<div class="col-sm-6">
					<div class="card">
						<h5 class="card-header">PDF Search</h5>
						<div class="card-body">
				...
				<div class="col-sm-6">
					<div class="card">
						<h5 class="card-header">Tokenizer</h5>
						<div class="card-body">
							<h5 class="card-title">File Viewer,  Tokenizer</h5>
				...
				<div class="col-sm-6">
					<div class="card">
						<h5 class="card-header">NMT Translation</h5>
						<div class="card-body">
							<h5 class="card-title">Neural Machine Translation</h5>
							<p class="card-text">Multiple languages</p>
							<a href="http://202.65.148.98/translate-onmt/" target="_blank" class="btn btn-primary">Open NMT</a>
						</div>
					</div>
				</div>
				<div class="col-sm-6">
				...
				<div class="col-sm-6">
					<div class="card">
						<h5 class="card-header">Transcription/SRT Work Bench</h5>
						<div class="card-body">
				...
				<div class="col-sm-6">
					<div class="card">
						<h5 class="card-header">Image to Text</h5>
						<div class="card-body">
				...
				<div class="col-sm-6">
					<div class="card">
						<h5 class="card-header">Diff Tool</h5>
						<div class="card-body">
				...
				<div class="col-sm-6">
					<div class="card">
						<h5 class="card-header">Bleu/Parallel Dict</h5>
						<div class="card-body">
